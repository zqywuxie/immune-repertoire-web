...
def test_single_rq_worker_completes_two_profile_analyses(tmp_path, monkeypatch):
    ...
    with app.app_context():
        ...
        pd.DataFrame({"sample":["A1","A2","A3","B1","B2","B3"],"group":["A"]*3+["B"]*3,"metric":[1,2,4,6,8,9]}).to_csv(profile,index=False)
